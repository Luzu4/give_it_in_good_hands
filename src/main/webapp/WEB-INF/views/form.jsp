    ...
    <div class="form--steps-container">
        ...
        <form:form name="donationForm" method="post" modelAttribute="donation">
            ...
            <div data-step="4">
                ...
                <div class="form-group form-group--buttons">
                    <button type="button" class="btn prev-step">Wstecz</button>
                    <button id="toConfButton" type="button" class="btn next-step">Dalej
                    </button>
                </div>
            </div>
                ...
                <div class="summary">
                    <div class="form-section">
                        ...
                        <ul>
                            <li>
                                ...
                                <span class="summary--text" id="confQuantity"
                            ...
                            <li>
                                ...
                                <span class="summary--text" id="confInstitution"
                                ></span
                                >
                            </li>
                        </ul>
                    ...
                    <div class="form-section form-section--columns">
                        <div class="form-section--column">
                            <h4>Adres odbioru:</h4>
                            <ul>
                                <li id="confPickUpStreet"></li>
                                <li id="confPickUpCity"></li>
                                <li id="confPickUpZipCode"></li>
                                <li id="confPickUpPhoneNumber"></li>
                            </ul>
                        </div>
                        ...
                        <div class="form-section--column">
                            <h4>Termin odbioru:</h4>
                            <ul>
                                <li id="confPickUpDate"></li>
                                <li id="confPickUpTime"></li>
                                <li id="confPickUpComment"></li>
                            </ul>
                        </div>
                    </div>
                </div>
